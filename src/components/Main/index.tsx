...
export const Main = () => {
    return (
        <main className="p-6   m-auto">
            <Title style={{ color: "white" }}>My Services</Title>
                ...
                <div className="grid sm:grid-cols-2  md:grid-cols-3  gap-2">
                    ...
                    <div className="py-2">
                        ...
                        <div>
                            ...
                            <p>
                                API (Application Programming Interface software) is a set of instructions, standards or
                                requirements that enables a software or app to employ features/services of another app
                            </p>
                        </div>
                    </div>
                </div>
